...
from freg_funkcijos_konceptai import normalize_text, openxml, print_xml, register_namespaces, remove_version_et, remove_version_str, sortCode
...
def main(file):
    ...
    filenames = os.listdir('excel_raktai_konceptai')

    for filename in filenames:
        wb = load_workbook(os.path.join('excel_raktai_konceptai', filename))
        ws_xml = wb['XML']
